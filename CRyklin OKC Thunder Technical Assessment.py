...
test_df['2PTA_shot_distribution'] = round(test_df['2PTA'] / test_df['FGA'],4)
test_df['C3A_shot_distribution'] = round(test_df['C3A'] / test_df['FGA'],4)
test_df['NC3A_shot_distribution'] = round(test_df['NC3A'] / test_df['FGA'],4)

test_df['EFG%'] = round((test_df['FGM'] + (0.5*(test_df['C3M']+test_df['NC3M']))) / test_df['FGA'],4)
